  ...
  const content = (
    <div className="mx-auto w-full max-w-5xl px-4 py-5 sm:px-6">
      <div className="mb-5 overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-blue-600 to-sky-500 p-5 text-white shadow-xl sm:p-7">
        ...
        <h2 className="mt-2 text-3xl font-bold sm:text-4xl">{roleLabels[role]}</h2>
        <p className="mt-2 max-w-2xl text-sm text-blue-50 sm:text-base">Standalone mobile task page for unfinished stock transfer workflow actions.</p>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        {tasks.length === 0 && <div className="rounded-2xl border border-dashed border-blue-200 bg-white/90 p-8 text-center text-sm text-gray-500 shadow-sm">No unfinished tasks.</div>}
      </div>
    </div>
  );
