...
const Reallocation = ({ data }) => {
    ...
    try {
      const promises = validRows.map(async (row) => {
        ...
        await addDoc(collection(firestoreDB, "reallocation_mail"), {
          to: ["darin@regentrv.com.au", "planning@regentrv.com.au", "marg@regentrv.com.au","karena@regentrv.com.au","davidw@regentrv.com.au"],
          message: {
  ...
  const handleIssueUpdate = async (chassisNumber, issueType, requestId) => {
    try {
      ...
      await addDoc(collection(firestoreDB, "reallocation_mail"), {
        to: ["planning@regentrv.com.au","darin@regentrv.com.au", "accounts.receivable@regentrv.com.au", "Ashley@regentrv.com.au","karena@regentrv.com.au","davidw@regentrv.com.au"],
        message: {
